...
<head>
    ...
    <link rel="stylesheet" href="../account/css/register.css">
    </link>
</head>
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-lg-5  bg-white">
                    <div class="row align-items-center m-h-100 bg-brown">
                        <div class="mx-auto col-md-8 form-register">
                            ...
                            <form action="" name="addUser" id="addU" method="POST" enctype="multipart/form-data">
                                <div class="form-col">
                                    <div class="form-group">
                                        <label class="label-input" for="inputName1">Full name</label>
                                    ...
                                    <div class="form-group">
                                        <label class="label-input" for="inp-role">Role</label>
                                ...
                                <button type="submit" name="registerAccount" class="btn btn-primary btn-block btn-lg btn-register">Register</button>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 d-none d-md-block bg-cover" style="background-image: url('./images/img_login_regis.jpg');">
