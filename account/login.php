    ...
    <body>
        ...
        ?>
            <div class="container-fluid">
                ...
                <div class="row ">
                    <div class="col-lg-6 d-none d-md-block bg-cover" style="
                        background-image: url('./images/img_login_regis.jpg');
                    ">
                    </div>
                    <div class="col-lg-6  bg-brown">
                                ...
                                <form action="" name="addUser" id="addU" method="POST" enctype="multipart/form-data">
                                    <div class="form-col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="usernameUserLogin" name="usernameUserLogin" placeholder="Username" required>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="input-group" style="flex-flow: row-reverse;" id="show_hide_password">
                                                        <input type="password" class="form-control" placeholder="Password" name="passwordUserLogin" id="passwordUserLogin" required>
                                    ...
                                    <hr>
                                    <button type="submit" name="loginAccount" class="btn btn-success btn-block btn-login btn-lg">Login</button>
                                    ...
                                    ?>
                                        <div class="social-login" style="margin-top: 3%;">
                                            <a href="<?= $authUrl ?>" class="btn btn-primary d-flex justify-content-center align-items-center btn-google p-2"><span class="fab fa-google-plus-g display-google-icon mr-2"></span>
                                                Signin with goole
                                            </a>
                                        </div>
                                    <?php
