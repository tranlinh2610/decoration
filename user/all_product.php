...
<div class="container-fluid result-search">
    ...
    <div class="list-all-product flex-container">
        <?php
        while ($productInfor = mysqli_fetch_array($resultPro, MYSQLI_ASSOC)) {
        ?>
            <div class="card align-items-center" id="card-product">
                <a href="index.php?view=detail&id=<?= $productInfor['p_id'] ?>&idc=<?= $productInfor['category_id'] ?>" style="text-decoration:none">
